...
if (isset($_POST['submit'])) {
        ...
        if (empty($_POST['title'])) {
                ...
                db_query("UPDATE `$mysqlMainDb`.cours
                          SET intitule = " . autoquote($_POST['title']) .",
                              faculte = " . htmlspecialchars(autoquote($facname)) . ",
                              description = " . autoquote($_POST['description']) . ",
                              course_addon = " . autoquote($_POST['course_addon']) . ",
                              course_keywords = ".htmlspecialchars(autoquote($_POST['course_keywords'])) . ",
                              visible = " . intval($_POST['formvisible']) . ",
                              titulaires = " . htmlspecialchars(autoquote($_POST['titulary'])) . ",
		...
		@$tool_content .="
		<form method='post' action='$_SERVER[PHP_SELF]'>".csrf_token()."
